...
export default function AnalysisWorkflowModal({ isOpen, onClose, zone }) {
  ...
  const STAGES = [
    {
      ...
      desc: 'Acquiring C-band Synthetic Aperture Radar (SAR) Single Look Complex (SLC) imagery from Sentinel-1 constellation in Interferometric Wide (IW) swath mode.',
      icon: Radar,
      duration: 1200,
    },
    {
      ...
      desc: 'Processing Small Bounding Baseline Subset interferometry. Unwrapping interferometric phase using SNAPHU and applying GACOS zenith tropospheric delay correction.',
      icon: Layers,
      duration: 1200,
    },
    {
      ...
      desc: 'MintPy baseline inversion across 24 historical acquisition dates to establish precise millimeter-level ground movement velocity.',
      icon: Activity,
      duration: 1200,
    },
    {
      ...
      stepNumber: '04',
      title: 'LSTM FORECAST',
      subtitle: '30-day deformation forecast generated',
      desc: 'Stacked Long Short-Term Memory (LSTM) recurrent neural network predicting 30-to-60 day displacement trajectory with 95% confidence bounds.',
      icon: Cpu,
      duration: 1200,
    },
    {
      ...
      desc: 'Evaluating multi-factor severity scoring matrix combining displacement velocity, acceleration gradient, and proximity to critical rural infrastructure.',
      icon: ShieldAlert,
      duration: 1200,
    },
    {
      ...
      desc: 'Synthesizing explainable evidence package and dispatching prioritized field verification task to regional ground inspection team.',
      icon: AlertTriangle,
      duration: 1500,
    },
  ];

  // Sequential Stage Timer
  useEffect(() => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/90 backdrop-blur-xl animate-fade-in">
      <div className="relative w-full max-w-4xl glass-panel-glow rounded-2xl border border-cyan-500/40 p-6 shadow-[0_0_50px_rgba(6,182,212,0.2)] overflow-hidden flex flex-col gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h2 className="text-lg font-bold font-display-title text-white">
                SATELLITE & IN-SAR ANALYSIS PIPELINE
              </h2>
            </div>
          </div>
        ...
        {/* Main Active Stage Interactive Visualization HUD */}
        <div className="relative z-10 p-6 rounded-2xl bg-slate-950/80 border border-cyan-500/30 min-h-[280px] flex flex-col justify-between">
          ...
          {/* Visual Canvas Simulations per stage */}
          <div className="mt-4 p-4 rounded-xl bg-slate-900/90 border border-white/10 min-h-[140px] flex items-center justify-center relative overflow-hidden">
            {currentStage === 1 && (
              <div className="flex flex-col items-center gap-3">
                <div className="relative w-24 h-24 rounded-full border border-cyan-500/40 flex items-center justify-center">
                  <div className="absolute inset-0 rounded-full border border-cyan-500/20 animate-radar-sweep origin-center bg-gradient-to-tr from-cyan-500/20 to-transparent" />
                  <Radar className="w-10 h-10 text-cyan-400 animate-pulse" />
                </div>
                <span className="text-xs font-mono-tech text-cyan-300">
                  Sentinel-1 Orbit Pass: Descending Track 165 · Swath Width: 250km
                </span>
              </div>
            )}
            ...
            {currentStage === 2 && (
              <div className="flex flex-col items-center gap-2 w-full max-w-md">
                <div className="text-xs font-mono-tech text-slate-300 flex items-center justify-between w-full">
                  <span>Phase Interference Fringes</span>
                  <span>SNAPHU Unwrapping</span>
                </div>
                {/* Fringe phase bars animation */}
            ...
            {currentStage === 3 && (
              <div className="w-full">
                <div className="text-xs font-mono-tech text-cyan-300 mb-1 text-center">
                  MintPy Displacement Baseline (24 Acquisitions)
                </div>
            ...
            {currentStage === 4 && (
              <div className="w-full">
                <div className="text-xs font-mono-tech text-orange-400 mb-1 text-center font-bold">
                  Stacked LSTM Neural Network Generating 30-Day Forecast Curve...
                </div>
            ...
            {currentStage === 5 && (
              <div className="flex items-center gap-8">
                <div className="text-center">
                  <div className="text-[10px] font-mono-tech text-slate-400 uppercase">CALCULATED RISK SCORE</div>
            ...
            {currentStage === 6 && (
              <div className="flex flex-col items-center gap-3 text-center">
                ...
                <div>
                  <h4 className="text-white font-bold font-mono-tech text-sm">
                    EARLY WARNING ALERT READY
                  </h4>
                  <p className="text-xs text-slate-300 mt-1">
                    Dispatching prioritized field inspection workflow for {zone.id}
                  </p>
                </div>
              </div>
            )}
